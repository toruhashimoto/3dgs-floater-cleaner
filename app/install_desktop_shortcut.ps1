# Creates a Desktop shortcut to 3DGS Floater Cleaner (run_desktop.bat).
...
$lnkPath = Join-Path $desktop '3DGS Floater Cleaner.lnk'
...
$sc.WindowStyle = 1
$sc.Description = '3DGS Floater Cleaner - low-floater 3DGS training (scale_reg)'
$sc.Save()
